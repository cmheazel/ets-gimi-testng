...
<ctl:package xmlns:ctl="http://www.occamlab.com/ctl"
  ...
  xmlns:tns="http://www.opengis.net/cite/gimi"
  xmlns:saxon="http://saxon.sf.net/"
  xmlns:tec="java:com.occamlab.te.TECore"
  xmlns:tng="java:org.opengis.cite.gimi.TestNGController">

  <ctl:function name="tns:run-ets-gimi">
   ...
   <ctl:suite name="tns:ets-gimi-${version}">
     <ctl:title>GIMI 1.0 Conformance Test Suite</ctl:title>
     <ctl:description>Verifies the structure and content of a GIMI file.</ctl:description>
     <ctl:starting-test>tns:Main</ctl:starting-test>
   </ctl:suite>
 
   <ctl:test name="tns:Main">
      <ctl:assertion>The GIMI file satisfies all applicable constraints.</ctl:assertion>
	  <ctl:code>
        <xsl:variable name="form-data">
           <ctl:form method="POST" width="800" height="600" xmlns="http://www.w3.org/1999/xhtml">
             <h2>GIMI 1.0 Conformance Test Suite</h2>
             ...
             <fieldset style="background:#ccffff">
               ...
               <p>
                 <label for="uri">
                   <h4 style="margin-bottom: 0.5em">Location of GIMI (absolute http: or file: URI)</h4>
                 </label>
                 <input id="uri" name="uri" size="128" type="text" />
               </p>
               <p>
                 <label for="doc">
                   <h4 style="margin-bottom: 0.5em">Upload GIMI</h4>
                 </label>
       ...
       <xsl:variable name="test-results">
        <ctl:call-function name="tns:run-ets-gimi">
